...
export class FixProjectStatusEnumPending1771103247242 implements MigrationInterface {
    name = 'FixProjectStatusEnumPending1771103247242'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_b63b5da7da7eeff64e1a6a9b45"`);
        await queryRunner.query(`CREATE TYPE "public"."project_project_status_enum_old" AS ENUM('PEDING', 'IN_PROGRESS', 'COMPLETED')`);
        await queryRunner.query(`ALTER TABLE "project" ALTER COLUMN "project_status" DROP DEFAULT`);
